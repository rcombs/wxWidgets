...
public:
    ...
    inline int GetMin() const wxOVERRIDE { return m_rangeMin; }
    inline int GetMax() const wxOVERRIDE { return m_rangeMax; }

    void SetMin(int minValue) { SetRange(minValue, m_rangeMax); }
    void SetMax(int maxValue) { SetRange(m_rangeMin, maxValue); }

    // For trackbars only
    inline int GetTickFreq() const wxOVERRIDE { return m_tickFreq; }
